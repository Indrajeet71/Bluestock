...
SECRET_KEY = 'django-insecure--65(x54fxo4z0kr&-pwn=-d_o93lmhf6l(-a$_o3*n^%!&3^(k'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://your-frontend-live-url.com",  # production frontend
]

# Django REST Framework Configuration
REST_FRAMEWORK = {
    'DEFAULT_SCHEMA_CLASS': 'drf_spectacular.openapi.AutoSchema',
    'DEFAULT_FILTER_BACKENDS': ['django_filters.rest_framework.DjangoFilterBackend'],  # <-- ADDED
}
